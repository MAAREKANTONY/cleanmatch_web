...
PIPELINE_PROGRESS_LOG_EVERY_ROWS = int(os.getenv('PIPELINE_PROGRESS_LOG_EVERY_ROWS', '5000'))
PIPELINE_EXPORT_PROGRESS_LOG_EVERY_ROWS = int(os.getenv('PIPELINE_EXPORT_PROGRESS_LOG_EVERY_ROWS', '10000'))
