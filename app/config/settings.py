...
BIGQUERY_CLEANUP_WORKDIR_FILES = os.getenv('BIGQUERY_CLEANUP_WORKDIR_FILES', '1').strip().lower() not in {'0', 'false', 'no', 'off'}
BIGQUERY_SOURCE_COLUMN_PRUNING = os.getenv('BIGQUERY_SOURCE_COLUMN_PRUNING', '1').strip().lower() not in {'0', 'false', 'no', 'off'}
PIPELINE_CHUNK_SIZE = int(os.getenv('PIPELINE_CHUNK_SIZE', str(BIGQUERY_READ_PAGE_SIZE)))
PIPELINE_AI_CHUNK_SIZE = int(os.getenv('PIPELINE_AI_CHUNK_SIZE', '500'))
PIPELINE_MAX_IN_MEMORY_ROWS = int(os.getenv('PIPELINE_MAX_IN_MEMORY_ROWS', str(max(PIPELINE_CHUNK_SIZE, PIPELINE_AI_CHUNK_SIZE))))
PIPELINE_RESUME_ENABLED = os.getenv('PIPELINE_RESUME_ENABLED', '1').strip().lower() not in {'0', 'false', 'no', 'off'}
...
APP_DISPLAY_VERSION = os.getenv('APP_DISPLAY_VERSION', '').strip()
